...
export default class PageList extends Component {
  render() {
    ...
    <Link to="/website/WebsiteList"><i class="fas fa-chevron-left"></i></Link>
    <span class="navbar-brand mb-0 h1">Pages</span>
    <Link to="/PageNew"><i class="fas fa-plus"></i></Link>
    </nav>
    ...
    <div class="container-left">
        ...
        <ul Class="list-group">
          ...
          <Link class="float-right" to="page/PageEdit"><i class="fas fa-cog"></i></Link>
          </li>
